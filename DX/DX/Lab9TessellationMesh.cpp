...
Lab9TessellationMesh::Lab9TessellationMesh(ID3D11Device* device, WCHAR* textureFilename)
{
...
Lab9TessellationMesh::~Lab9TessellationMesh()
{
	// Run parent deconstructor
	BaseMesh::~BaseMesh();
}

void Lab9TessellationMesh::InitBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	...
	vertices[5].position = XMFLOAT3(0.0f, 1.0f, 0.0f);  // Top Left.
...
void Lab9TessellationMesh::SendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
